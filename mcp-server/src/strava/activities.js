...
export function mapActivity(raw) {
  ...
  return {
    ...
    avg_cadence: raw.average_cadence != null ? Math.round(raw.average_cadence * 2) : null,
    elevation_gain: raw.total_elevation_gain != null ? Math.round(raw.total_elevation_gain) : null,
